        ...
        <section className="relative flex w-full flex-1 min-h-0 flex-col items-center">
          ...
          <div className="relative flex w-full flex-1 min-h-[440px] items-center justify-center">
            <div className="relative aspect-square w-full max-w-[640px] sm:max-w-[560px] md:max-w-[600px]">
              ...
              <div className="absolute left-1/2 top-1/2 z-40 flex aspect-square w-[88%] min-w-[260px] max-w-[520px] -translate-x-1/2 -translate-y-1/2 flex-col overflow-y-auto overflow-x-hidden rounded-full border border-white/70 bg-white/90 shadow-[0_25px_60px_-35px_rgba(15,23,42,0.55)] backdrop-blur sm:w-[80%] scroll-smooth">
