              ...
              <div className="absolute left-1/2 top-1/2 z-40 flex aspect-square w-[92%] min-w-[260px] max-w-[520px] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[42px] border border-white/15 bg-white/20 shadow-[0_25px_60px_-35px_rgba(15,23,42,0.2)] backdrop-blur sm:w-[80%]">
                ...
                {hasConversationStarted ? (
                  <>
                    ...
                    >
                      {!isHistoryView && (
                        <div className="pointer-events-none absolute inset-x-4 top-0 z-30 h-24 bg-gradient-to-b from-white/70 via-white/30 to-transparent sm:inset-x-6" />
                      )}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="min-h-[18px] pt-1">
                          {persona.isTyping && (
                            <span className="rounded-full bg-gradient-to-r from-violet-500/90 to-sky-500/90 px-2 py-0.5 text-[10px] font-bold text-white shadow">
                              در حال تایپ
                            </span>
                          )}
