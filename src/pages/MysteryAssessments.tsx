        ...
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-6 md:px-6">
          <div className="space-y-2 text-right">
            ...
            <p className="max-w-xl text-sm leading-7 text-slate-600">
              در هر رازمایی، مجموعه‌ای از تصاویر روایت‌محور به نمایش گذاشته می‌شود. نگاه دقیق تو، سرنخ‌ها را آشکار می‌کند و در پایان، هوش مصنوعی با چند سوال هدفمند عمق تحلیل تو را می‌سنجد.
            </p>
          </div>
          <Button
            variant="ghost"
          ...
          <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div className="space-y-5 text-right">
              ...
              <p className="text-sm leading-7 text-slate-700">
                ابتدا به کمک اسکرول سینمایی، تصاویر را با تمرکز کامل مشاهده می‌کنی. سپس در گفتگو با «رازمَستر»، برداشت‌ها، نشانه‌ها و رازهایی که کشف کرده‌ای را بازگو می‌کنی. هوش مصنوعی با طرح پرسش‌های عمیق‌تر، نگاه تحلیلی تو را به چالش می‌کشد و در نهایت گزارشی از مسیر کشف تو ارائه می‌دهد.
              </p>
              ...
              <CardContent className="space-y-4 p-6 text-right">
                ...
                <div className="flex flex-col gap-3 rounded-2xl bg-white/10 p-4">
                  ...
                  <ul className="space-y-2 text-sm leading-6 text-white/90">
                    ...
                    <li>۲. کشف جزئیات تصاویر با اسکرول سینمایی</li>
